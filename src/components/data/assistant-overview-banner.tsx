...
export async function AssistantOverviewBanner({ assistants }: AssistantOverviewBannerProps) {
  ...
  return (
    <Link
      href="/assistants"
      className="group flex items-center gap-4 rounded-lg border border-blue-100 bg-blue-50/60 px-4 py-3 transition-all hover:border-blue-200 hover:bg-blue-50 dark:border-blue-900/40 dark:bg-blue-950/20 dark:hover:border-blue-800 dark:hover:bg-blue-950/30"
    >
