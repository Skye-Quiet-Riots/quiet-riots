...
export default function SignUpPage() {
  ...
  async function handleOAuth(provider: string) {
    ...
    // Auth.js will redirect to the newUser page after first-time OAuth sign-in
      ...
      <div className="mx-auto flex min-h-[60vh] max-w-sm flex-col items-center justify-center px-4">
        <div className="w-full rounded-xl border border-zinc-200 bg-white p-8 text-center shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400">
            We sent a sign-in link to your email address. Click the link to create your account.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="mx-auto flex min-h-[60vh] max-w-sm flex-col items-center justify-center px-4">
      <div className="w-full rounded-xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        <h1 className="mb-2 text-center text-2xl font-bold">Join Quiet Riots</h1>
        <p className="mb-6 text-center text-sm text-zinc-500 dark:text-zinc-400">
          Organise around shared issues. Take action together.
        </p>
        ...
        <form onSubmit={handleEmail} className="space-y-3">
          ...
          >
            {isLoading === 'email' ? 'Sending link...' : 'Sign up with email'}
          </button>
        </form>
